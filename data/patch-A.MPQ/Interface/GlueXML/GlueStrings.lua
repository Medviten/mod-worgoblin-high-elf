...
RACE_INFO_OGRE_FEMALE = "Brutish, strong, and far cleverer than their enemies assume, the ogres have long fought for whoever paid in gold or meat. Weary of servitude to gronn and warlords alike, a band of clans has thrown in with the Horde, trading their mercenary past for a warchief worth following.|n|nOgres take to battle with joyous abandon, and the rare, usually two-headed, ogre magi among them wield surprisingly potent sorcery. What they lack in grace they make up for in sheer, wall-cracking muscle.";
