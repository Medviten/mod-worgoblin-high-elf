...
RACE_INFO_OGRE = "Brutish, strong, and far cleverer than their enemies assume, the ogres have long fought for whoever paid in gold or meat. Weary of servitude to gronn and warlords alike, a band of clans has thrown in with the Horde, trading their mercenary past for a warchief worth following.|n|nOgres take to battle with joyous abandon, and the rare, usually two-headed, ogre magi among them wield surprisingly potent sorcery. What they lack in grace they make up for in sheer, wall-cracking muscle.";
...
RACE_INFO_BLOODELF_FEMALE = RACE_INFO_BLOODELF;
...
RACE_INFO_DRAENEI_FEMALE = RACE_INFO_DRAENEI;
...
RACE_INFO_DWARF_FEMALE = RACE_INFO_DWARF;
...
RACE_INFO_GNOME_FEMALE = RACE_INFO_GNOME;
...
RACE_INFO_HUMAN_FEMALE = RACE_INFO_HUMAN;
...
RACE_INFO_NIGHTELF_FEMALE = RACE_INFO_NIGHTELF;
...
RACE_INFO_ORC_FEMALE = RACE_INFO_ORC;
...
RACE_INFO_SCOURGE_FEMALE = RACE_INFO_SCOURGE;
...
RACE_INFO_TAUREN_FEMALE = RACE_INFO_TAUREN;
...
RACE_INFO_TROLL_FEMALE = RACE_INFO_TROLL;
