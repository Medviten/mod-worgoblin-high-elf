...
UPDATE `faction` SET `reputation_base_2` = 400, `reputation_flags_2` = 273 WHERE `id` = @HighElfFaction; -- High Elven Loyalists
...
UPDATE `faction` SET `reputation_flags_1` =  (`reputation_flags_1` & ~0x10) | 0x02, `reputation_flags_2` =  (`reputation_flags_1` & ~0x10) | 0x02, `reputation_flags_3` =  (`reputation_flags_1` & ~0x10) | 0x02, `reputation_flags_4` =  (`reputation_flags_1` & ~0x10) | 0x02 WHERE `id` IN (@HumanFaction, @OrcFaction, @DwarfFaction, @NightElfFaction, @UndeadFaction, @TaurenFaction, @GnomeFaction, @TrollFaction, @BloodElfFaction, @DraeneiFaction, @GoblinFaction, @WorgenFaction, @HighElfFaction, @MagharOrcFaction, @OgreFaction);
