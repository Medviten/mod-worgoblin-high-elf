...
UPDATE `faction` SET `reputation_flags_1` = (`reputation_flags_1` & ~0x10), `reputation_flags_2` = (`reputation_flags_2` & ~0x10), `reputation_flags_3` = (`reputation_flags_3` & ~0x10), `reputation_flags_4` = (`reputation_flags_4` & ~0x10) WHERE `id` IN (
