...
(
	@GoblinCriteria2, -- criteria_id (Achievement 2422 (Shake Your Bunny-Maker))
	...
	@WorgenCriteria2, -- criteria_id (Achievement 2422 (Shake Your Bunny-Maker))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1: The target here is a valid class (paste class list). value2 must also be set
	...
	@GoblinCriteria3, -- criteria_id (Achievement 291 (Check Your Head))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1: The target here is a valid class (paste class list). value2 must also be set
	@Goblin, -- value2: The value here is a valid race ID. See ChrRaces.dbc
	'' -- ScriptName
), (
	@WorgenCriteria3, -- criteria_id (Achievement 291 (Check Your Head))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1: The target here is a valid class (paste class list). value2 must also be set
	@Worgen, -- value2: The value here is a valid race ID. See ChrRaces.dbc
	'' -- ScriptName
), (
	@GoblinCriteria4, -- criteria_id (Achievement 1429 (Realm First! Level 80 Goblin))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1: Make instance script call for check current criteria requirements fit.
	@Goblin, -- value2: The value here is a valid race ID. See ChrRaces.dbc
	'' -- ScriptName
), (
	@WorgenCriteria4, -- criteria_id (Achievement 1430 (Realm First! Level 80 Worgen))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1
	@Worgen, -- value2: The value here is a valid race ID. See ChrRaces.dbc
	'' -- ScriptName
