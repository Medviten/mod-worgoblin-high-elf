...
DELETE FROM `creaturedisplayinfo` WHERE `id` IN (
    ...
    @DruidBearTrollBlueDisplay,     @DruidBearTrollPurpleDisplay,    @DruidBearTrollRedDisplay,       @DruidBearTrollWhiteDisplay,     @DruidBearTrollYellowDisplay,
    ...
    @DruidCatTrollSkinBlackDisplay, @DruidCatTrollSkinBlueDisplay,   @DruidCatTrollSkinGreenDisplay,  @DruidCatTrollSkinRedDisplay,    @DruidCatTrollSkinWhiteDisplay
);
...
(92600, 3141, 0, 62100, '1.0000000000000000', 255, '', '', '', '', 0, 0, 0, 0, 0, 0), -- worgen male ("skinless")
(92601, 3141, 0, 62101, '1.0000000000000000', 255, '', '', '', '', 0, 0, 0, 0, 0, 0), -- worgen male ("skinless")
(92602, 3142, 0, 62102, '1.0000000000000000', 255, '', '', '', '', 0, 0, 0, 0, 0, 0), -- worgen female ("skinless")
(92603, 3142, 0, 62103, '1.0000000000000000', 255, '', '', '', '', 0, 0, 0, 0, 0, 0), -- worgen female ("skinless")
(92604, 3142, 0, 62104, '1.0000000000000000', 255, '', '', '', '', 0, 0, 0, 0, 0, 0), -- worgen female ("skinless")
(92605, 3141, 0, 62105, '1.0000000000000000', 255, '', '', '', '', 0, 0, 0, 0, 0, 0), -- worgen male ("skinless")
