...
UPDATE `charsections` SET `race` = @Skeleton          WHERE `race` = 14;
UPDATE `charsections` SET `race` = @Vrykul            WHERE `race` = 15;
UPDATE `charsections` SET `race` = @Tuskarr           WHERE `race` = 16;
UPDATE `charsections` SET `race` = @ForestTroll       WHERE `race` = 17;
UPDATE `charsections` SET `race` = @Tuskarr           WHERE `race` = 18;
