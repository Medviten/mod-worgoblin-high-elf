...
UPDATE `charhairgeosets` SET `race` = @Skeleton          WHERE `race` = 14;
UPDATE `charhairgeosets` SET `race` = @Vrykul            WHERE `race` = 15;
UPDATE `charhairgeosets` SET `race` = @Tuskarr           WHERE `race` = 16;
UPDATE `charhairgeosets` SET `race` = @ForestTroll       WHERE `race` = 17;
UPDATE `charhairgeosets` SET `race` = @Tuskarr           WHERE `race` = 18;
