...
-- New entries
DELETE FROM `achievement_criteria` WHERE `id` IN (13498, 13499, 19217);
...
(13498, 2422, 110, 61815, 1, 0, 0, 0, 0, 'Mag\'har', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 16712190, 0, 0, 0, 0, 14),
(13499, 291, 110, 44212, 1, 0, 0, 0, 0, 'Mag\'har', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 16712190, 0, 0, 0, 0, 14),
(19217, 1432, 5, 80, 0, 0, 0, 0, 0, 'Level to 80', '80 레벨', 'Atteindre le niveau 80', 'Erreicht Stufe 80', '升到80级', '升至80級', 'Alcanza el nivel 80', 'Alcanza el nivel 80', 'Достигнуть 80-го уровня', '', '', '', '', '', '', '', 16712190, 2, 0, 0, 0, 1);
