...
-- New entries
DELETE FROM `achievement_criteria` WHERE `id` IN (13484, 13485, 19215, 19216);
...
(13484, 2422, 110, 61815, 1, 0, 0, 0, 0, 'High Elf', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 16712190, 0, 0, 0, 0, 13),
(13485, 291, 110, 44212, 1, 0, 0, 0, 0, 'High Elf', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 16712190, 0, 0, 0, 0, 13),
(19215, 246, 53, 13, 1, 0, 0, 0, 0, 'High Elf', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 16712190, 0, 0, 0, 0, 6),
(19216, 1431, 5, 80, 0, 0, 0, 0, 0, 'Level to 80', '80 레벨', 'Atteindre le niveau 80', 'Erreicht Stufe 80', '升到80级', '升至80級', 'Alcanza el nivel 80', 'Alcanza el nivel 80', 'Достигнуть 80-го уровня', '', '', '', '', '', '', '', 16712190, 2, 0, 0, 0, 1);
