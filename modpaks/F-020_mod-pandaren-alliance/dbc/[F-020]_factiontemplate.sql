DELETE FROM `factiontemplate` WHERE `id` IN (@HordePandarenFactionTemplate, @AlliancePandarenFactionTemplate);
...
(@HordePandarenFactionTemplate, @HordePandarenPlayer, 72, 5, 4, 10, 0, 0, 0, 0, 0, 0, 0, 0), -- "PLAYER"," HordePandaren", copied from Troll
