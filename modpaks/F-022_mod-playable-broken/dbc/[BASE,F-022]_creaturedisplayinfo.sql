...
-- New entries
DELETE FROM `creaturedisplayinfo` WHERE `id` IN (@BrokenMaleDisplay, @BrokenFemaleDisplay);
...
(@BrokenMaleDisplay, @BrokenMaleModel, 0, @BrokenMaleDisplayExtra, '1.1699999570846558', 255, '', '', '', '', 3, 0, 0, 0, 0, 0),
(@BrokenFemaleDisplay, @BrokenFemaleModel, 0, @BrokenFemaleDisplayExtra, '1.1699999570846558', 255, '', '', '', '', 3, 0, 0, 0, 0, 0);
