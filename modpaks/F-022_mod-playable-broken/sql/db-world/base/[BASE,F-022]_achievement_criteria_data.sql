...
(
	@BrokenCriteria2, -- criteria_id (Achievement 2422 (Shake Your Bunny-Maker))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1: The target here is a valid class (paste class list). value2 must also be set
	@Broken, -- value2: The value here is a valid race ID. See ChrRaces.dbc
	'' -- ScriptName
), (
	@BrokenCriteria2, -- criteria_id (Achievement 2422 (Shake Your Bunny-Maker))
	9, -- type: TYPE_T_LEVEL
	...
	@BrokenCriteria3, -- criteria_id (Achievement 291 (Check Your Head))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1: The target here is a valid class (paste class list). value2 must also be set
	@Broken, -- value2: The value here is a valid race ID. See ChrRaces.dbc
	'' -- ScriptName
), (
	@BrokenCriteria4, -- criteria_id (Achievement 1431 (Realm First! Level 80 High Elf))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1
	@Broken, -- value2: The value here is a valid race ID. See ChrRaces.dbc
	'' -- ScriptName
