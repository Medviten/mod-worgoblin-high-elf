...
(
	@MagharOrcCriteria2, -- criteria_id (Achievement 2422 (Shake Your Bunny-Maker))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1: The target here is a valid class (paste class list). value2 must also be set
	@MagharOrc, -- value2: The value here is a valid race ID. See ChrRaces.dbc
	'' -- ScriptName
), (
	@MagharOrcCriteria2, -- criteria_id (Achievement 2422 (Shake Your Bunny-Maker))
	9, -- type: TYPE_T_LEVEL
	...
	@MagharOrcCriteria3, -- criteria_id (Achievement 291 (Check Your Head))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
	0, -- value1: The target here is a valid class (paste class list). value2 must also be set
	@MagharOrc, -- value2: The value here is a valid race ID. See ChrRaces.dbc
	'' -- ScriptName
), (
	@MagharOrcCriteria4, -- criteria_id (Achievement 1429 (Realm First! Level 80 Mag'har Orc))
	2, -- type: TYPE_T_PLAYER_CLASS_RACE
