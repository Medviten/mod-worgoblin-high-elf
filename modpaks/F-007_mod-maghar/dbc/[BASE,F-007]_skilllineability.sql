...
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 3274; -- Spell: 3563 (Teleport: Undercity)
...
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 15252; -- Spell: 34767 (Summon Charger) [ARAC]
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 15253; -- Spell: 34769 (Summon Warhorse) [ARAC]
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 15606; -- Spell: 35715 (Teleport: Shattrath)
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 15607; -- Spell: 35717 (Portal: Shattrath)
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 17000; -- Spell: 49358 (Teleport: Stonard)
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 17003; -- Spell: 49361 (Portal: Stonard)
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 18308; -- Spell: 53733 (Judgement of Corruption) [ARAC]
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 18311; -- Spell: 53736 (Seal of Corruption) [ARAC]
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 18314; -- Spell: 53742 (Blood Corruption) [ARAC]
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 20090; -- Spell: 34767 (Summon Charger) [ARAC]
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 20092; -- Spell: 34769 (Summon Warhorse) [ARAC]
UPDATE `skilllineability` SET `required_races` = `required_races` | @MagharOrcMask WHERE `id` = 20110; -- Spell: 55531 (Mechano-hog)
