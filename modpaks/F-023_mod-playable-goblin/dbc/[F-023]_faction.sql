-- faction: 2 inserts, 1 updates, 0 deletes

-- new entries
DELETE FROM `faction` WHERE `id` IN (@GoblinPlayer, @GoblinFaction);
...
UPDATE `faction` SET
  `reputation_race_mask_1` = `reputation_race_mask_1` | @GoblinMask,
